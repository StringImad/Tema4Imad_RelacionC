...
public class Empleado {
    ...
    public Empleado(String nombre, String apellidos, String Nif, double sueldoBase, double pagoHoraExtra, int horasExtrasRealizadas, double tipoIrpf, boolean estaCasado, int numHijos) {
        this.nombre = nombre;
